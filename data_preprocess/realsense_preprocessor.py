...
class RealSensePreprocessor(DataPreprocessor):
    """
    Preprocessor for the dataset collected by a RealSense camera
    """
    ...
    def __init__(self, dataset_path, device, full_ZSAD, split, seed):
        ...
        """
        super(RealSensePreprocessor, self).__init__(dataset_path, None, None, None, device, full_ZSAD)
