...
class Kitti12Preprocessor(DataPreprocessor):
    """
    ...
    def __init__(self, dataset_path, max_disp, block_sz, match_method, device, full_ZSAD, split, seed):
        ...
        """
        super(Kitti12Preprocessor, self).__init__(dataset_path, max_disp, block_sz, match_method, device, full_ZSAD)
        self.split = split
    ...
    def preprocess(self):
        ...
        for scene in scene_list:
            scene_count += 1
            self.l_im_path = os.path.join(self.dataset_path, scene, "colored_0")
            self.r_im_path = os.path.join(self.dataset_path, scene, "colored_1")
