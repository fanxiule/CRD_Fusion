...
class ZEDDataset(CRDFusionDataset):
    def __init__(self, data_path, max_disp, downscale, resized_height, resized_width, conf_thres, is_train,
        ...
        """
        Dataset to load and prepare data for training/validation from a dataset collected by a ZED camera
        ...
        """
        super(ZEDDataset, self).__init__(data_path, max_disp, downscale, resized_height, resized_width,
