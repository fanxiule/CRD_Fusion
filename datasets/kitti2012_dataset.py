...
class Kitti2012Dataset(CRDFusionDataset):
    def __init__(self, data_path, max_disp, downscale, resized_height, resized_width, conf_thres, is_train,
        ...
        """
        Dataset to load and prepare data for training/validation from KITTI 2012 dataset
        ...
        """
        super(Kitti2012Dataset, self).__init__(data_path, max_disp, downscale, resized_height, resized_width,
